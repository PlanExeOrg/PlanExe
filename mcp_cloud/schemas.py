...
TOOL_DEFINITIONS = [
    ...
    ToolDefinition(
        ...
        description=(
            ...
            "Set monitor=true to block and receive MCP progress notifications (notifications/progress and "
            "notifications/message) every ~10 seconds until the plan completes — no polling needed. "
            "When monitor=false (default), returns immediately; use plan_status to poll. "
