...
class TestPlanResumeTool(unittest.TestCase):
    ...
    def test_plan_resume_returns_structured_content(self):
        ...
        self.assertEqual(result.structured_content["resume_count"], 1)
    ...
    def test_plan_resume_returns_plan_not_resumable(self):
        ...
        self.assertTrue(result.is_error)
        self.assertEqual(result.structured_content["error"]["code"], "PLAN_NOT_RESUMABLE")
    ...
    def test_plan_resume_returns_pipeline_version_mismatch(self):
        ...
        self.assertTrue(result.is_error)
        self.assertEqual(result.structured_content["error"]["code"], "PIPELINE_VERSION_MISMATCH")
