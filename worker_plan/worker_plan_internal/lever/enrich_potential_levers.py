...
**Lever identifiers:** Each lever in the batch is wrapped in `<lever>uuid</lever>` XML tags. When returning `lever_id`, extract and return only the hexadecimal uuid string inside the tags — strip the XML tags themselves.
